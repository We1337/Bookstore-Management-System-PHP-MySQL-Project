            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content rounded-4 shadow">
                    ...
                    <div class="modal-header p-5 pb-4 border-bottom-0">
                        <h1 class="fw-bold mb-0 fs-2">Support login</h1>
                    </div>

                    <div class="modal-body p-5 pt-0">
                        <form class="login" action="functions/process_login.php" method="POST">
                            
                            <div class="form-floating mb-3">
                                <input name="username" type="text" class="form-control rounded-3" id="floatingInput" placeholder="Username">
