...
<div id="content">
    <div class="post">
        <h2 class="title"><a href="#">Card</a></h2>
        <p class="meta"></p>
        <div class="entry">
            <form action="addtocard.php" method="post">
                <table class="card" cellspacing="0" border="0" width="100%">
                    <tr align="center">
                        <th width="7%">No</th>
                        <th width="30%">Name</th>
                    ...
                    <?php
                        ...
                        {
                            foreach($_SESSION['card'] as $id=>$val)
                            {
                                ...
                                echo '
                                    <tr>
                                        ...
                                        <td>'.$val['price'].'</td>
                                        <td>'.$rate.'</td>
                                        <td><a style="color: red;text-decoration:none;" href="addtocard.php?id='.$id.'">X</a></td>
                                    </tr>';
