<?php
    ...
    if($customerid == null) {
        ...
        $customerid = setCustomer($name, $address, $city, $zip_code, $country);
    }
    ...
    foreach($_SESSION['card'] as $isbn => $qty) {
...
?>
    ...
    <p class="lead text-success">Your order has been processed sucessfully. Please check your email to get your order confirmation and shipping detail!. Your card has been empty.</p>
