...
?>
    ...
    <a href="admin_sigout.php" class="btn btn-primary">Sign out!</a>
    <table class="table" style="margin-top: 20px">
        ...
        <tr>
            ...
            <td><a href="admin_delate.php?bookisbn=<?php echo $row['book_isbn']; ?>">Delete</a></td>
        </tr>
        <?php } ?>
    </table>

<?php
    if(isset($conn))  mysqli_close(1conn); }
